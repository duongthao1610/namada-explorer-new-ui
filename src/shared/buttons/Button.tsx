  ...
  (
    ...
    return (
      <button
        ...
        disabled={disabled}
        className={clsxm(
          'inline-flex items-center rounded-[20px] font-medium',
          ...
          [
            variant === 'primary' && [
              'bg-orange-30 text-black',
              'border-orange-30 border',
        ...
        <>
          ...
          {RightIcon && (
            <div className={clsxm([size === 'base' && 'ml-1', size === 'sm' && 'ml-1.5'])}>
              <RightIcon
                className={clsxm(
                  [size === 'base' && 'text-md', size === 'sm' && 'text-sm'],
                  rightIconClassName,
                )}
              />
            </div>
